# Nudibranchs in Full Color!
## Tracing Their Roots and Radiant Hues
Nudibranchs are often tiny, toxic sea slugs that are brightly colored. They're a favorite for scuba divers who like little things to look at. New ones are being discovered all the time. The Smithsonian's invertebrate zoology collection has a number of specimens which include nudibranchia. The data available for this Order includes location, taxonomic name, depth found (and others) – some of these aspects are explored in my project. I specifically highlight a geographical map for location, color categorizations (swatches generated by Vibrant.js), the taxonomic name of these marine slugs, and an image from the Smithsonian's collection.
![Hero-1](https://github.com/user-attachments/assets/90803371-957d-4671-9c7e-04b632dd0d9a)
![Hero-2](https://github.com/user-attachments/assets/bfccf729-1e7d-469e-9462-2f41a2d72211)
![Hero-3](https://github.com/user-attachments/assets/447c2bcb-4422-49fc-8851-5bf8a2b4a87c)
![Hero-4](https://github.com/user-attachments/assets/6d68a500-eec7-4364-b124-0f0b7913d84f)
https://lisasquinley.github.io/MS1-F24-LSQ/
